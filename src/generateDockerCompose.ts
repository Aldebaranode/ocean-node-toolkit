...
export function generateDockerCompose(allConfigs: NodeConfig[]) {
  ...
  ${conf.node_name}:
    ...
    environment:
      ...
      P2P_ANNOUNCE_ADDRESSES: '["/dns4/${conf.environment.IP_ADDRESS}/tcp/9000/p2p/", "/dns4/${conf.environment.IP_ADDRESS}/ws/tcp/9001", "/dns6/${conf.environment.IP_ADDRESS}/tcp/9002/p2p/", "/dns6/${conf.environment.IP_ADDRESS}/ws/tcp/9003"]'
    networks:
      - ocean_network
    depends_on:
